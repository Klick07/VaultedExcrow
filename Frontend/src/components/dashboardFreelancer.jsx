  ...
  return (
    <div className="[background:radial-gradient(ellipse_at_center,_#1a2535_0%,_#080d14_100%)] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-pretty text-white sm:text-2xl">Active & Ongoing Projects</h1>
          ...
          {posts.map((post) => (
            ...
            >
              <div className="flex items-center gap-x-4 text-xs">
                ...
                <div className="text-gray-400 p-1 rounded-full border">{post.stats}</div>
              </div>
