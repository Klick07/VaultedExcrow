...
export default function FreelancerDashboard() {
  ...
  const showmodal = useStore((state) => state.showmodal); // ADDED
  const openModal = useStore((state) => state.openModal);
  const contracts = useStore((state) => state.contracts); // ADDED
  ...
  return (
    <div className="[background:radial-gradient(ellipse_at_center,_#1a2535_0%,_#080d14_100%)] py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* CHANGED — data replaced with allActiveProjects */}
